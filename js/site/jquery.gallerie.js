	...
	$.fn.gallerie = function (method) {
		...
		function rebuildOverlay(target, imageLinks){
			var $this = $(target),
				...
				$captionBox = $('<div class="gallerie-captionbox"><div class="gallerie-text"><div class="gallerie-title"/><div class="gallerie-index"/></div></div> <div class="gallery-nav"> <div class="gallerie-control gallerie-control-previous"><img src="js/previous.png"></div> <div class="gallerie-control gallerie-control-next"><img src="js/next.png"></div></div> '),
				$thumbList = $('<ul></ul>'),
