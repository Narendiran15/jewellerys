						...
						<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 membership-input-base" id="personal_tab">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 app_input_base">
								...
								<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common">
									...
									<input type="text" autocomplete="false" class="app-input-control" name="dob" id="dob">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 app_input_base ">
								...
								<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common emp_hide">
									...
									<input type="text" class="app-input-control " name="reg_date" id="reg_date">
								...
								<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common emp_hide">
									...
									<input type="text" class="app-input-control " name="reg_number" id="reg_number">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 app_input_base ">
								...
								<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common priority_hide">
									...
									<select name="priority_category" class="select-control app-input-control">
										<option value="">Select Priority Category</option>
										<?php if ($priority_list->num_rows() > 0) {
											foreach ($priority_list->result() as $priority) { ?>
												<option data-age="<?php echo $priority->age_limit; ?>" value="<?php echo $priority->priority_name; ?>"><?php echo $priority->priority_name; ?></option>
										<?php }
										} ?>
								...
								<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common priority_hide">
									...
									<input type="text" class="app-input-control " name="cer_no">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 app_input_base ">
								...
								<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common">
									...
									<input type="text" class="app-input-control" value="Tamil" name="lang[]">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 app_input_base ">
								...
								<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common">
									...
									<input type="text" class="app-input-control" value="English" name="lang[]">
