<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 member-directory-details-base" >
  <div class="container nopadd">
	 <p class="back-page"><a href="javascript:void(0);" id="searchback_btn"><span class="back-icon"><img src="<?php echo base_url();?>images/site/back-icon.png" alt="GSLN"></span>Back</a></p>
	 <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 member-directory-details-inner">
		<h4 class="site-head text-center"><?php echo ucfirst($company_info->trading_name);?></h4>
		...
		<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 member-directory-profile" id="append_branch_search_html_div">
		   ...
		   <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 member-directory-profile-inner">
			  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 member-directory-profile-rgt">
						...
						<table style="width: 100%;" id="ref_table">
								...
								<tbody>
											...
											<tr class="">
												...
												<td colspan="5"><p>No News found. </p></td>					
