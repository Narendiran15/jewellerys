...
<div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 membership-inner nopadd">
	...
	<form method="post" id="edit_member_user_form" enctype="multipart/form-data" autocomplete="off">
	<div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 membership-cotent-base">

			<h2 class="site-head">Update Member Profile</h2>
			...
			<div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 upload-container">  
					...
					<div class="upload-container-content">
									...
									<?php }else { ?>
										<img id="pro_img" src="<?php echo base_url();?>images/site/files/thumb/<?php echo $company_info->logo; ?>" />
									<?php } ?>
			...
			<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 membership-input-base">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 app_input_base ">
											...
											<?php /*<div class="col-md-4 col-sm-4 col-xs-12 col-lg-4 app_input_common">

															<label class="label-control">How did you hear of GLSN</label>
							...
							<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 app_input_base text-right margin-small">
									...
									<a href="javascript:void(0);" id="edit_register_user_btn" class="themebtn"><span class="arrow-icon"><img src="<?php echo base_url();?>images/site/arrow-icon.png"></span>Save</a>
...
<script>
$(document).on("click","#edit_register_user_btn",function(){
	$("#edit_member_user_form").submit();
})
