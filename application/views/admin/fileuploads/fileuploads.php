				  ...
				  foreach($filesuploads->result() as $pimg){
					  ...
					  $needle = 'are';	
					   if (strpos($pimg->file_name,".pdf") !== false) {
						...
						$filename=base_url()."images/site/fileuploads/".$pimg->file_name;   
					   }
				?>
				<li class="span3 span3 ui-sortable-handle">
                  <div class="photo_inner_li">
                     <div class="photo_preview_inner">
						...
						<div class="download_photo" data-name="<?php echo $pimg->file_name;?>"><a href="<?php echo base_url();?>images/site/fileuploads/<?php echo $pimg->file_name;?>" download><span class="fa fa-download"></span></a></div>	
						<div class="link_photo" data-name="<?php echo $pimg->file_name;?>"><a target="new" href="<?php echo base_url();?>images/site/fileuploads/<?php echo $pimg->file_name;?>" ><span class="fa fa-link"></span></a></div>		
                     ...
                     <div class="photo_preview_inner">
                        <div class="last_photo_plus">
                           <div class="browse_photo" id="add_last_index">
                              ...
                              <form id="uploadimage" action="<?php echo base_url()?>admin/fileuploads/ajax_img_upload"  method="post" enctype="multipart/form-data"> 
...
$(document).on("change","#upload_img",function(){ 
  ...
  var game_image_size=$("#imgupload_ul").attr("data-size"); 
	...
	$.ajax({
	url: baseurl+"admin/fileuploads/image_uploads", 
	type: "POST",             
	data: data, 
	dataType: "json",
	contentType: false,       
...
$(document).on("click",".delete_photo",function(){
	...
	var lival=$(this);
	$.post(baseurl+'admin/fileuploads/delete_fileuploads_img',{'fname':fname},function(data){
