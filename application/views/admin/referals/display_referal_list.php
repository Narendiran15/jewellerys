			...
			<table id="city_table" class="table table-bordered table-striped">
                <thead>
														<tr>
															...
															<th id="ajax_url" data-url="<?php echo base_url('admin/referals/display_referals') ?>" data-name="id">Sno</th>
															<th data-name="company_name">Referred By</th>
															<th data-name="member_name">Member Name</th>
															<th data-name="prospect_company">Prospect's Company</th>
															<th data-name="prospect_contact_name">Prospect's Contact Name</th>
															<th data-name="sent_date">Send</th>
															<th data-name="update">
																Update
															</th>
														</tr>
