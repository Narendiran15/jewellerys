...
$title = '<table>
	<tr>
        ...
        <td colspan="3" align="left">'.$this->config->item('site_name').' Subadmin Details</td>
...
header("Content-Disposition: attachment; filename=".$this->config->item('site_name')."_subadmin_list.xls");
