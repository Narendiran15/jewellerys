			...
			<table id="city_table" class="table table-bordered table-striped">
                <thead>
														<tr>
															...
															<th id="ajax_url" data-url="<?php echo base_url('admin/news/display_industry_news') ?>" data-name="id">Sno</th>
															<th data-name="title">Title</th>
															<th data-name="name">Company</th>
															<th data-name="archive">Archive</th>
