			...
			<table id="city_table" class="table table-bordered table-striped">
                <thead>
														<tr>
															...
															<th id="ajax_url" data-url="<?php echo base_url('admin/summits/display_Assignsummits/'.$summit_id) ?>" data-name="id">Sno</th>
															<th data-name="company_name">CompanyName</th>
															<th data-name="summit_name">Summit Name</th>
															<th data-name="update">
																Update
															</th>
														</tr>
