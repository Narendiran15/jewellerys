			...
			<div class="box-body">
                <div class="form-group">
                  ...
                  <select name="company_id" class="form-control">
					  ...
					  <?php if($company_list->num_rows()>0){ foreach($company_list->result() as $company){ ?>	
					  <option <?php if(!empty($user)){ echo $user->company_id==$company->id?"selected":""; } ?> value="<?php echo $company->id;?>"><?php echo $company->name; ?></option>	
					  <?php }} ?>
				  </select>
                </div>
