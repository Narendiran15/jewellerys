...
<a class="close" data-dismiss="modal" href="javascript:void(0);">x</a>
  ...
  <h1><small><?php echo $heading;?></small></h1>
	  ...
	  <a style="float:right;" class="btn btn-success" href="<?php echo base_url();?>admin/users/export_users_list" >Export</a>
  </section>	
<!--End-breadcrumbs-->
          ...
          <div class="box">
			...
			<div class="box-body">
              <table id="user_table" class="table table-bordered table-striped">
                <thead>
                <tr>
				<th id="ajax_url" data-url="<?php echo base_url('admin/users/display_users') ?>" data-name="id">Sno</th>
