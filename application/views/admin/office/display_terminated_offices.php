          ...
          <div class="box">
			...
			<div class="box-body">
              <table id="user_table" class="table table-bordered table-striped">
                <thead>
                <tr>
				<th id="ajax_url" aria-sort="descending" data-url="<?php echo base_url('admin/office/display_terminatedOffices') ?>" data-name="id">Sno</th>
				<th data-name="name">Company Name</th>
				<th data-name="country_name">Country</th>
				<th data-name="port_name">Branch Name</th>							
